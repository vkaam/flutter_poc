...
class TravelCardList extends StatefulWidget {
  ...
  const TravelCardList({Key key, this.sessions, @required this.onSessionChange})
      : super(key: key);
...
class TravelCardListState extends State<TravelCardList>
    ...
    return Container(
      ...
      child: Rotation3d(
        ...
        child: TravelCardRenderer(
          ...
          session: widget.sessions[itemIndex % widget.sessions.length],
  ...
  bool _handleScrollNotifications(Notification notification) {
    ...
    if (notification is ScrollUpdateNotification) {
      ...
      widget.onSessionChange(widget.sessions
          .elementAt(_pageController.page.round() % widget.sessions.length));
    }
    //Scroll Start
